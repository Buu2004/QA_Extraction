...
output_folder_1 = './Template1(ques-ans-sol)/synthesize_input'
output_folder_2 = './Template1(ques-ans-sol)/synthesize_output'
    ...
    while created_files < total_files:
        ...
        with open(output_file_2, 'w', encoding='utf-8') as f:
            ...
            for i in selected_questions_indices:
                ...
                f.write(f"<choices> {ans_list[j]} <choices\>\n")
                f.write("\n")
                
                f.write(f"<solution> {sol_list[j]} <solution\><question\>\n")
                f.write("\n")
